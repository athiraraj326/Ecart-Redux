      ...
      <div style={{paddingTop:'100px'}} className="container px-4 mx-auto">
       { 
            ...
            <div className="grid grid-cols-3 gap-4 mt-5">
              <div className="col-span-2 border rounded shadow p-5">
                  ...
                  <tbody>
                    {
                      ...
                      <tr key={product?.id}>
                        <td>{index+1}</td>
                        <td>{product?.title}</td>
                        <td><img width={'70px'} style={{height:'70px'}} src={product?.thumbnail} alt="" /></td>
                        <td>
                          <div className='flex'>
                ...
                <div className="float-right mt-4">
                  ...
                  <Link className='bg-blue-600 text-white p-2 rounded' to={'/'}>SHOP NOW</Link>
                </div>
              </div>
          ...
          <div className='flex flex-col justify-center items-center'>
            ...
            <h1 className="text-blue-600 font-bold text-2xl my-5">Your Cart is Empty!!!</h1>
          </div>
        }
      </div>
    </>
